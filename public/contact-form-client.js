import flatpickr from "https://cdn.jsdelivr.net/npm/flatpickr@4.6.13/dist/flatpickr.esm.js";
...
function initContactForm() {
  ...
  const startDatePicker = flatpickr(dateInput, {
    ...
    minDate: "today",
    appendTo: startDateParent ?? undefined,
    onValueUpdate: () => {
      syncDateClearButtons();
    },
  ...
  endDatePicker = flatpickr(dateEndInput, {
    ...
    monthSelectorType: "static",
    minDate: "today",
    appendTo: endDateParent ?? undefined,
    onValueUpdate: () => {
      syncDateClearButtons();
    },
    onChange: (selectedDates) => {
